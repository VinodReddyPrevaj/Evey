...
class AllVisitsTableViewController: UITableViewController,CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if Constants.recentAllVists.count == 0 {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return Constants.recentAllVists.count
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        resident = Constants.recentAllVists[indexPath.row] as! NSDictionary
        ...
        let careStatus = resident.value(forKey: "care_status") as! String
        ...
        cell.visitImage.image = UIImage(named: _typeImage)
        ...
        cell.visitImage.frame = CGRect(x: cellWidth/31.25, y: cellHeight/4.057, width: cellWidth/25, height: cellWidth/25)
